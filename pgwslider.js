    ...
    $.fn.pgwSlider = function(options) {
        ...
        var getElement = function(obj) {
            ...
            if ((typeof elementLink != 'undefined') && (elementLink != '')) {
				...
				var elementLinkClass = obj.find('a').attr('class');
                if ((typeof elementLinkClass != 'undefined') && (elementLinkClass != '')) {
                    element.linkClass = elementLinkClass;
                }
            }
        ...
        var updateHeight = function(height, animate) {
            ...
            if (pgwSlider.config.maxHeight) {
                if (pgwSlider.plugin.width() > 480 && height > pgwSlider.config.maxHeight) {
                    height = pgwSlider.config.maxHeight+100;
        ...
        var setup = function() {
            ...
            pgwSlider.plugin.find('.ps-list > li').each(function() {
                ...
                if (element.link) {
                    currentElement.html('<a href="' + element.link + '"' + (element.linkTarget ? ' target="' + element.linkTarget + '"' : '') + ' ' + (element.linkClass ? ' class="' + element.linkClass + '"' : '') + '>' + currentElement.html() + '</a>');
                }
